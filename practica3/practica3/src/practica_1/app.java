package EstructurasDeSeleccio.practica_1;
...
public class app {
    public static void main(String[] args) {
        ...
        if (1 == entrada.length() && letra >= 97 && letra <= 122) { //comprueba si la entrada es un solo caracter y si ese caracter es una letra
